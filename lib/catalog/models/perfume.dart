class Perfume {
  ...
  const Perfume({required this.externalId, required this.name, this.brand, this.imageUrl, this.releaseYear, this.rating, this.gender, this.longevity, this.sillage, this.notes = const [], this.mainAccords = const []});
  ...
  factory Perfume.fromJson(Map<String, dynamic> json) => Perfume(
    ...
    releaseYear: json['releaseYear'] as int?, rating: (json['rating'] as num?)?.toDouble(), gender: json['gender'] as String?,
